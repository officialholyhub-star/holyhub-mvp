...
export function MarketNav({ area = "customer" }: { area?: "customer" | "seller" | "admin" }) {
  ...
  const links = area === "seller" ? [["/seller","Overview"],["/seller/products","Products"],["/seller/orders","Orders"],["/seller/finances","Earnings"],["/account/business","Storefront"]] : area === "admin" ? [["/admin","Applications"],["/admin/marketplace","Marketplace"],["/admin/events","Events"],["/admin/refunds","Refund reviews"],["/admin/settings","Settings"],["/admin/audit","Activity"]] : [["/account","Account"],["/orders","My orders"],["/basket","Basket"],["/notifications","Notifications"],["/seller","Seller hub"]];

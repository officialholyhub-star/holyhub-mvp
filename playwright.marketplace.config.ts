...
export default defineConfig({
 ...
 webServer:[
  {command:"node tests/fixtures/marketplace-api.mjs",url:"http://127.0.0.1:54331/__test/health",timeout:60_000,env:{HOLYHUB_DEMO_API_PORT:"54331",HOLYHUB_DEMO_SAMPLE_DATA:"true"}},

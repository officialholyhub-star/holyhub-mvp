...
start(['tests/fixtures/marketplace-api.mjs'],{HOLYHUB_DEMO_API_PORT:String(apiPort),HOLYHUB_DEMO_SAMPLE_DATA:process.argv.includes('--sample-data')?'true':'false'});
...
console.log(`\nHolyHub local preview: http://127.0.0.1:${port}\nStarts with no accounts or listings. Sample fixtures require npm run demo:samples.\nNo real emails or payments. Do not enter personal information; local data resets when restarted.\n`);
